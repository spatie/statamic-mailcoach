<svg class="h-full mr-2" style="width: 45px" fill="none" viewBox="0 0 570 305" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
        <linearGradient id="c" x1="276.89" x2="505.74" y1="77.23" y2="77.23" gradientUnits="userSpaceOnUse">
            <stop stop-color="#172A9F" offset=".0012034"/>
            <stop stop-color="#172A9F" offset="1"/>
        </linearGradient>
